...
const LandingPage = () => {
  ...
  return (
    <>
      <BlurBackground />
      <div className="z-10 flex items-center justify-center h-screen flex-col">
        <div className="bg-buttonColor w-[234px] h-[209px] rounded-[66px]">
          {/* Logo with alt text */}
          <img
            src={Logo}
            alt="Logo"
            className="z-10 justify-center m-auto mt-5"
          />
        </div>
        {/* Text and buttons under the logo */}
        <div className="flex flex-col items-center">
          <h1 className="font-bold text-[20px] text-center mt-10">
            Discover movies and share with friends!
          </h1>
          ...
          <p
            className="absolute bottom-7 underline text-[14px]"
            onClick={goToLogIn}
          >
            Already a member?
          </p>
